...
\begin{figure}[ht]
    \centering
    \subfloat[Pincushion Distortion]{\includegraphics[width=0.225\textwidth]{figures/pincushion}}
    \hfil
    \subfloat[Barrel Distortion]{\includegraphics[width=0.225\textwidth]{figures/barrel}}
